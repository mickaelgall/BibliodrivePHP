Bonjour je m'appelle Mickaël Gall, bienvenue dans ma bibliodrive !
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand" href="http://127.0.0.1/PHP/bibliodrive/accueil.php">   <img src="table-enchantement-minecraft.jpg" alt="bibliothèque " width="50" height="50"></a>
        ...
        <div class="collapse navbar-collapse" id="mynavbar">
          <ul class="navbar-nav me-auto">
            <li class="nav-item">
              <a class="nav-link" href="http://127.0.0.1/PHP/bibliodrive/panier.php">panier<img src="Livre.jpg" alt="bibliothèque " width="35" height="35"></a>
            </li>
