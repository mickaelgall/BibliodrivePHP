Bonjour je m'appelle Mickaël Gall, bienvenue dans ma bibliodrive !
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand" href="http://127.0.0.1/PHP/BibliodrivePHP/accueil.php">   <img src="table-enchantement-minecraft.jpg" alt="bibliothèque " width="50" height="50"></a>
